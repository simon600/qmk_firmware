...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_82(
        ...
        KC_LCTL,        KC_LOPTN,   GUI_LEAD,                                     LT(MAC_FN, KC_SPC),                       KC_RALT,    FN_MAC,   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_82(
        ...
        KC_CAPS,        MR1,        MR2,      KC_DEL,     _______,    _______,    KC_LEFT,    KC_DOWN,  KC_UP,    KC_RGHT,  _______,    _______,            _______,            KC_END,
