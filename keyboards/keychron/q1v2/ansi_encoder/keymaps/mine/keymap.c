...
#define FN_LMAC FN_LEAD(MAC_FN)
#define FN_LWIN FN_LEAD(WIN_FN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_82(
        ...
        _______,        MS,         M_NW,  C(KC_RGHT),    _______,    _______,    _______,    _______,  _______,  _______,  _______,    _______,  _______,  _______,            _______,
        CW_TOGG,        MR1,        MR2,      KC_DEL,     _______,    _______,    KC_LEFT,    KC_DOWN,  KC_UP,    KC_RGHT,  _______,    _______,            _______,            KC_END,
