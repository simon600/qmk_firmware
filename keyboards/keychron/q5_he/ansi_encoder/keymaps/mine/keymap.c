...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_101(
        ...
        KC_LCTL,               LALT_LEAD,KC_LGUI,                                    LT(MAC_FN, KC_SPC),                       KC_RALT,    FN_MAC,   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,            KC_P0,    KC_PDOT,  KC_PENT),
    ...
    [MAC_FN] = LAYOUT_ansi_101(
        ...
        KC_CAPS,               MR1,      MR2,        KC_DEL,   KC_BSPC,    _______,  KC_LEFT,    KC_DOWN,  KC_UP,    KC_RGHT,  _______,    _______,            _______,            KC_END,   _______,  _______,  _______,  _______,
